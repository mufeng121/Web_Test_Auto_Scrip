...
HEADER = {'Access-Control-Allow-Origin': '*',
          ...
          'Content-Length': '830',
          'ETag': 'W/"33e-U/iGgvq/5akBbVWHC2tliKBMIHA"', 'Vary': 'Accept-Encoding', 'Connection': 'keep-alive'}
...
TEST_HEADER = {
    ...
    # 'Cookie': 'language=en; welcomebanner_status=dismiss; cookieconsent_status=dismiss; continueCode=WaDV1LvjPGkLhxtvUWHWTXSniaZfPJH2luVxSEaUnBhOOIkosJx0rygYlN8n; token=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..dShk5yC4Fv8vRW3G8LCQMKOcp1QcaEh8j-c_awG2AY7jVCBQVBu70kIoJjKoozgWV-XHyGGM453h-pVdVZtgbLWn2u5oVHwupkNFdMT296X1joHnL29bFQcUNQY5QpiWrjsf_GC9mWZYuavorrxib1grpD-bkd6n-BEpQ1R-Mz4',
}
